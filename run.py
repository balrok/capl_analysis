...
def print_global_functions():
    ...
    print("void write(std::string &a, ...){assert(a!=null);}")
    print("int sysGetVariableInt(std::string &a, std::string &a1){ assert(a!=null&&a1!=null); return 0; }")
    print("long sysGetVariableLong(std::string &a, std::string &a1){ assert(a!=null&&a1!=null);return 0; }")
    print("long sysGetVariableLongLong(std::string &a, std::string &a1){ assert(a!=null&&a1!=null); return 0; }")
    print("void sysSetVariableInt(std::string &a, std::string &a1, int a2){assert(a!=null&&a1!=null&&a2!=-1);}")
    print("void sysSetVariableLong(std::string &a, std::string &a1, long a2){assert(a!=null&&a1!=null&&a2!=-1); }")
    print("void sysSetVariableLongLong(std::string &a, std::string &a1, long a2){assert(a!=null&&a1!=null&&a2!=-1); }")
    print("void sysSetVariableString(std::string &a, std::string &a1, char a2[]){assert(a!=null&&a1!=null&&a2!=-1); }")
    ...
    print("int i=0;")
    print("write('');")
    print("i+=sysGetVariableInt('', '');")
    print("i+=sysGetVariableLong('', '');")
    print("i+=sysGetVariableLongLong('', '');")
    print("sysSetVariableInt('','',0);")
    print("sysSetVariableLong('','',0);")
    print("sysSetVariableLongLong('','',0);")
    print("sysSetVariableString('','','');")
    print("i+=random(0);")
    print("i+=elcount();")
    print("i+=_max(0,0);")
    print("i+=_min(0,0);")
    ...
    print("setTimer(0);")
    print("fileClose(0);")
    print("i+=openFileWrite('',0);")
    print("filePutString ('',0,0);")
    print("output(null);")
    print("memcpy();")
    print("return i;}")
